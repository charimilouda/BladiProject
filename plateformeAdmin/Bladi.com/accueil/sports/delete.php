...
$resultat=mysqli_query($con,"DELETE FROM sports WHERE ID='$id'");
if($resultat)
{
    
    ?>
    <meta http-equiv='refresh' content="0, url=sports.php">
    <?php
    echo "<script>alert ('Salle de sport supprimée avec succès')</script>";
