    ...
    <div class="container">
        ...
        <main>
            <div class="subcontainer">
                ...
                <div class="upload"><!--mazal maraha khedama ze3ma le style--> <!--data:image;base64,'.base64_encode($ligne->nomphoto1).'-->
                <?php 
                ...
                <div class="details hotel">
                    <div class="inputs"><!--fields-->
                        <div class="input-field">
                            ...
                            <input type="text" id="name" name="name" placeholder="entrer le nom de l'hotel" required value="<?php 
                           $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="adresse" name="adresse" placeholder="entrer l'adresse de l'hotel" required value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="website" name="website" placeholder="entrer le site web de l'hotel"value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="tel" name="tel" placeholder="entrer le tel de l'hotel" value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="lat" name="lat" placeholder="entrer l'attityde de l'hotel"  required value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <label for="long"> <span class="required">*</span> Longitude </label>
                                <input type="text" id="long" name="long" placeholder="entrer l'ong de l'hotel"  required value="<?php 
                                    $query=mysqli_query($con,"SELECT * FROM HOTELS WHERE ID='$id';");
                                    if(!$query)
                                    {   
                                        echo "Erreur dans l'exécution de la requête. ";
                    ...
                    <div class="buttons">
                        <button class="Annuler" type="reset" onclick="window.location.href='../hotels.php';"> 
