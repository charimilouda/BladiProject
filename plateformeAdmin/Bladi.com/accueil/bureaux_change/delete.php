...
$resultat=mysqli_query($con,"DELETE FROM bureauchange WHERE ID='$id'");
if($resultat)
{
    
    ?>
    <meta http-equiv='refresh' content="0, url=bureaux_change.php">
    <?php
    echo "<script>alert ('Bureau supprimé avec succes')</script>";
