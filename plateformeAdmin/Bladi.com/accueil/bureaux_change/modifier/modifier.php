<?php
        ...
        $id= $_REQUEST['id'];
        $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
        ?>    
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="details hotel">
                    <div class="inputs"><!--fields-->
                        <div class="input-field">
                            ...
                            <input type="text" id="name" name="name" placeholder="entrer le nom du bureau de change" required value="<?php 
                           $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="adresse" name="adresse" placeholder="entrer l'adresse du bureau de change" required value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="website" name="website" placeholder="entrer le site web du bureau de change"value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="tel" name="tel" placeholder="entrer le téléphone du bureau de change" value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="lat" name="lat" placeholder="entrer latitude du bureau de change"  required value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <label for="long"> <span class="required">*</span>Longitude </label>
                                <input type="text" id="long" name="long" placeholder="entrer longitude du bureau de change"  required value="<?php 
                                    $query=mysqli_query($con,"SELECT * FROM bureauchange WHERE ID='$id';");
                                    if(!$query)
                                    {   
                                        echo "Erreur dans l'exécution de la requête. ";
