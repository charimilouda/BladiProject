<?php
        ...
        $res=mysqli_query($con,"SELECT * FROM services_publiques ORDER BY id DESC LIMIT 1;");
        if(!$res)
        {
            ...
            $query=mysqli_query($con,"insert into services_publiques values('$id','$nom','$description','$tel','$website','$services','$adresse','$att','$long','$rating','$image1','$image2','$image3','$image1name','$image2name','$image3name');");//attention ici c'est tres important d'ajouter '' je dois pas mettre les variables tous seul , comme je peux pas utilise ""
