<?php
        ...
        $id= $_REQUEST['id'];
        $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
        ?>    
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="details hotel">
                    <div class="inputs"><!--fields-->
                        <div class="input-field">
                            ...
                            <input type="text" id="name" name="name" placeholder="entrer le nom de la banque" required value="<?php 
                           $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="adresse" name="adresse" placeholder="entrer l'adresse de la banque" required value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="website" name="website" placeholder="entrer le site web de la banque"value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="tel" name="tel" placeholder="entrer le téléphone de la banque" value="<?php 
                                $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                if(!$query)
                                {   
                                    echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="lat" name="lat" placeholder="entrer latitude de la banque"  required value="<?php 
                                    $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                    if(!$query)
                                    {   
                                        echo "Erreur dans l'exécution de la requête. ";
                        ...
                        <label for="long"> <span class="required">*</span> Longitude </label>
                                <input type="text" id="long" name="long" placeholder="entrer longitude de la banque"  required value="<?php 
                                    $query=mysqli_query($con,"SELECT * FROM banques WHERE ID='$id';");
                                    if(!$query)
                                    {   
                                        echo "Erreur dans l'exécution de la requête. ";
                    ...
                    <div class="buttons">
                        <button class="Annuler" type="reset" onclick="window.location.href='../banques.php';"> 
