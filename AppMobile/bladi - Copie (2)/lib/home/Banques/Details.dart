import 'package:bladi/home/Banques/adressMap.dart';
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => Banques_screen()),
                              );
                  },
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileBanques(image: image1,):(index==1?ListTileBanques(image: image2,):ListTileBanques(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileBanques extends StatelessWidget {
  const ListTileBanques({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
