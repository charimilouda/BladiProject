import 'package:bladi/home/Transportation/adressMap.dart';
        ...
        child: Container(
          child: Column(
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => Transportation_screen()),
                              );
                  },
                          ),
                        ),
              ...
              webSite==""?SizedBox(height: 0,):Text("Site Web ",
                textAlign: TextAlign.start,
                style: TextStyle(
                    color: ColorBladi.main2Color,
                    fontSize: 18,
              ...
              webSite==""?SizedBox(height: 0,):SizedBox(height: 12,),
              webSite==""?SizedBox(height: 0,):Container(
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileTransportation(image: image1,):(index==1?ListTileTransportation(image: image2,):ListTileTransportation(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileTransportation extends StatelessWidget {
  const ListTileTransportation({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
