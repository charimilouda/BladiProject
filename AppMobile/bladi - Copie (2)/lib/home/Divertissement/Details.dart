import 'package:bladi/home/Divertissement/adressMap.dart';
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => Divertissement_screen()),
                              );
                  },
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileDivertissement(image: image1,):(index==1?ListTileDivertissement(image: image2,):ListTileDivertissement(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileDivertissement extends StatelessWidget {
  const ListTileDivertissement({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
