import 'package:bladi/home/Pharmacies/adressMap.dart';
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => Pharmacies_screen()),
                              );
                  },
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTilePharmacies(image: image1,):(index==1?ListTilePharmacies(image: image2,):ListTilePharmacies(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTilePharmacies extends StatelessWidget {
  const ListTilePharmacies({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
