import 'package:bladi/home/BureauxChange/adressMap.dart';
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => BureauxChange_screen()),
                              );
                  },
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileBureauxChange(image: image1,):(index==1?ListTileBureauxChange(image: image2,):ListTileBureauxChange(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileBureauxChange extends StatelessWidget {
  const ListTileBureauxChange({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
