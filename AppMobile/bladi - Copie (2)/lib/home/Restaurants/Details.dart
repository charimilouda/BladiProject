...
import 'package:bladi/home/Restaurants/adressMap.dart';
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder: (context) => Restaurants_screen()),
                              );
                  },
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileRestaurants(image: image1,):(index==1?ListTileRestaurants(image: image2,):ListTileRestaurants(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileRestaurants extends StatelessWidget {
  const ListTileRestaurants({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
