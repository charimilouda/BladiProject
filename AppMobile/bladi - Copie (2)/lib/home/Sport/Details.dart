import 'package:bladi/home/Sport/adressMap.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  return index==0?ListTileSport(image: image1,):(index==1?ListTileSport(image: image2,):ListTileSport(image: image3,));
                }),
              ),
              SizedBox(height: 12,),
              Text("Adresse",
...
class ListTileSport extends StatelessWidget {
  const ListTileSport({Key? key, required this.image}) : super(key: key);
  final String image;
  @override
  Widget build(BuildContext context) {
    return Container(
